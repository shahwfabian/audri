...
const STATE_PROGRAMS: StateProgram[] = [
 ...
 { state: "Florida", abbr: "FL", program: "Florida Bright Futures Scholarship", agency: "Florida Department of Education", amountText: "75 to 100% tuition & fees", eligibility: "Florida resident, Florida high school graduate meeting GPA, test score, and service-hour requirements." },
 ...
 { state: "Missouri", abbr: "MO", program: "Missouri Bright Flight Scholarship", agency: "Missouri Department of Higher Education", amountText: "Up to $3,000/yr", amount: 3000, eligibility: "Missouri resident scoring in the top 3 to 5% on the ACT/SAT, attending a Missouri institution." },
