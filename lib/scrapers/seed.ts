...
export const SEED_SCHOLARSHIPS: ScrapedScholarship[] = [
  ...
  // ── Community Service ──────────────────────────────────────────────────────
  {
    ...
    eligibility:
      "Student in grades 5–12 enrolled in a U.S. school. Must demonstrate outstanding volunteer community service.",
  ...
  // ── Arts / Creative ────────────────────────────────────────────────────────
  {
    ...
    eligibility:
      "Students in grades 7–12 enrolled in U.S. schools. Original artwork or writing in one of 29 categories.",
  ...
  // ── Military / Public Service ──────────────────────────────────────────────
  {
    ...
    eligibility:
      "U.S. citizen. 17–26 years old. Enrolled or accepted at a college with Army ROTC. Minimum 2.5 GPA. Physical fitness requirements.",
