...
const STATUS_STYLE: Record<ApplicationStatus, { bg: string; color: string; border: string; label: string }> = {
 ...
 IN_PROGRESS: { bg: "rgba(255, 255, 255,0.12)", color: "var(--gold-light)", border: "rgba(255, 255, 255,0.35)", label: "In Progress" },
 DRAFT_READY: { bg: "rgba(255, 255, 255,0.08)", color: "var(--gold)", border: "rgba(255, 255, 255,0.25)", label: "Draft Ready" },
...
export default function DashboardPage() {
 ...
 {/* Onboarding banner */}
 {!onboardingComplete && (
 <div className="rounded-2xl p-6 gradient-brand flex items-center justify-between" style={{ boxShadow: "0 0 40px rgba(255, 255, 255,0.2)" }}>
 <div>
 ...
 {[
 { href: "/scholarships/search", icon: Search, label: "Find Scholarships", iconColor: "var(--gold)", iconBg: "rgba(255, 255, 255,0.12)" },
 ...
 { href: "/generate", icon: Sparkles, label: "Write an Essay", iconColor: "var(--gold)", iconBg: "rgba(255, 255, 255,0.12)" },
 ...
 {/* Tip card */}
 <div className="rounded-2xl p-5" style={{ background: "linear-gradient(135deg, rgba(255, 255, 255,0.12), rgba(255, 255, 255,0.04))", border: "1px solid rgba(255, 255, 255,0.2)" }}>
 ...
 {/* Daily Checklist */}
 <div className="rounded-2xl overflow-hidden" style={{ border: "1px solid rgba(255, 255, 255,0.25)", background: "var(--surface)" }}>
 {/* Header */}
 <div className="p-5 flex items-center justify-between" style={{ borderBottom: "1px solid var(--border)", background: "linear-gradient(90deg, rgba(255, 255, 255,0.06), transparent)" }}>
 <div className="flex items-center gap-3">
 <div style={{ width: 36, height: 36, borderRadius: "0.75rem", background: "rgba(255, 255, 255,0.15)", display: "flex", alignItems: "center", justifyContent: "center" }}>
 ...
 {/* Streak badge */}
 {(daily?.streak ?? 0) > 0 && (
 <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full" style={{ background: "rgba(255, 255, 255,0.12)", border: "1px solid rgba(255, 255, 255,0.25)" }}>
