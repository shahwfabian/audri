    ...
    <div className="max-w-4xl mx-auto space-y-6 pb-10">
      ...
      <div className="rounded-2xl p-4 flex items-start gap-3" style={{ background: "var(--gold-10)", border: "1px solid var(--gold-25)" }}>
        ...
        <p className="text-xs leading-relaxed" style={{ color: "var(--gold-light)" }}>
          These are mirrors, not masks. Pick the theme that matches <span className="font-semibold">your real life</span> —
          Audri helps you tell your true story with power, and never invents one for you.
        </p>
      </div>
