...
function ResumePreview({ resume }: { resume: Resume }) {
 ...
 <>
 <div className="pb-0.5 mb-2" style={{ borderBottom: "1px solid #F0F0F0" }}>
 ...
 <span className="mt-0.5" style={{ color: "#F0F0F0" }}>•</span>
 <span>{b}</span>
 </div>
 ) : null)}
 </div>
...
export default function ResumePage() {
 ...
 border: selectedType === type.value ? "1px solid rgba(255, 255, 255,0.35)" : "1px solid var(--border)",
