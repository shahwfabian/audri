    ...
    >
      <defs>
        <linearGradient id="audri-gold" x1="0" y1="64" x2="64" y2="0" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="var(--gold-dark, #8A6E30)" />
          <stop offset="0.5" stopColor="var(--gold, #C9A84C)" />
          <stop offset="1" stopColor="var(--gold-light, #E2C675)" />
        </linearGradient>
      </defs>
